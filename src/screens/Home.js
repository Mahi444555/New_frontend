...
function Home() {
  ...
  const loadData = async () => {
    ...
    await fetch("https://mybackendproject.onrender.com/foodData", {      //here we accessing that api/endpoint or connecting to that backend used to fetched backed data for cards
      method: "post",
      headers: {
